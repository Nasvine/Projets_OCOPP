...
<template>
                  ...
                  <div class="Search" >
                      <section class="dropdown-wrapper" style="font-family: Arial;">
                              <div @click="isVisible = !isVisible" class="selected-item">
                                ...
                                <span v-else > Nom du Bénéficiaire</span>
                              ...
                              <div :class="isVisible ? 'visible' : 'invisible'" class="dropdown-popover">
                                ...
                                <div class="options">
                                    <ul>
                                        <li @click="selectItem(partners)" v-for="(partners, index) in filteredUser" class="element" :key="index">{{partners.name}}</li>
                                    </ul>
                                </div>
                              </div> 
                ...
                <table class="striped"  style="width:100%">
                  <thead>
                    <tr > 
                      ...
                      <th  style="background-color: rgba(0, 0, 0, 0.53);  color: white; width:50%" scope="col" >Produits</th>
                      <th  style="background-color: rgba(0, 0, 0, 0.53);  color: white; width:50%" scope="col" >Quantité</th>
                  ...
                  <tbody style="background-color: white">
                    <tr v-for="(t, index) in tableau" :key="index">
                      <td>
                        <input class="filled-in checkbox-pink" style="opacity:1 ;pointer-events: auto;" :id="index" v-model="selected" :value="t"  type="checkbox"/></td>
                      <td>{{ t.name }}</td>
  ...
  <!-- <div v-for="(el, index) in tab" :key="index">{{el}}</div> -->
              ...
              <div class="input-field col s12 m6">
                <input type="number" placeholder="Quantité" v-model="quantity_ajouter" style="border: 1px solid white; background-color: white;"/> 
              </div>
              <div class="input-field col s12 m1">
                <button @click="Ajouter" class="waves-effect waves-light btn-small right" style="background-color: rgba(0, 0, 0, 0.53); ">OK</button>
              </div>
            </div>
          </form>
        </div>
      ...
      <div class="centre">
        ...
        <button @click="Envoyer"  class="button button2" style="background-color: rgba(98, 109, 210, 1); color: white; border: 1px solid silver;"> Enregistrer</button>
  ...
  methods: {
    ...
    Ajouter(){
     if(this.quantity_ajouter !==0){
        ...
        name: this.selection,
        quantity_done: this.quantity_ajouter,
      });
    ...
    Envoyer(){
        ...
        this.$http
         .post('http://api.odoo.ocoop.rintio.com/odoo/api/v1.0/receipts/',

          this.table.push({
          partner_id:  this.partner_id,
          name_of_partner:  this.name_of_partner,
          date: this.date,
  ...
  computed:{
           ...
           filteredUser(){
               ...
               return this.partners.filter((partners) => {
                   return Object.values(partners).some((word) => String(word).toLowerCase().includes(query)
                   );
               });
           },
           filteredUser_un(){
